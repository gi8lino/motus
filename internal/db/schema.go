...
func (s *Store) EnsureSchema(ctx context.Context) error {
	...
	stmts := []string{
		...
		`ALTER TABLE workout_steps ADD COLUMN IF NOT EXISTS repeat_count INT NOT NULL DEFAULT 1`,
		`ALTER TABLE workout_steps ADD COLUMN IF NOT EXISTS repeat_rest_seconds INT NOT NULL DEFAULT 0`,
		`ALTER TABLE workout_steps ADD COLUMN IF NOT EXISTS repeat_rest_after_last BOOLEAN NOT NULL DEFAULT FALSE`,
		`ALTER TABLE workout_steps ADD COLUMN IF NOT EXISTS repeat_rest_sound_key TEXT NOT NULL DEFAULT ''`,
		`ALTER TABLE workout_steps ADD COLUMN IF NOT EXISTS repeat_rest_auto_advance BOOLEAN NOT NULL DEFAULT FALSE`,
